...
RouteBase get $calendarRoute => GoRouteData.$route(
  ...
  routes: [
    ...
    GoRouteData.$route(path: 'conflicts', factory: _$ConflictsRoute._fromState),
    GoRouteData.$route(
      path: 'events/new',

      factory: _$EventCreateRoute._fromState,
    ),
  ],
);
...
mixin _$SidebarRoute on GoRouteData {
  static SidebarRoute _fromState(GoRouterState state) => const SidebarRoute();
...
mixin _$ConflictsRoute on GoRouteData {
  static ConflictsRoute _fromState(GoRouterState state) =>
      const ConflictsRoute();

  @override
  String get location => GoRouteData.$location('/calendar/conflicts');
...
mixin _$EventCreateRoute on GoRouteData {
  static EventCreateRoute _fromState(GoRouterState state) =>
      const EventCreateRoute();

  @override
  String get location => GoRouteData.$location('/calendar/events/new');
